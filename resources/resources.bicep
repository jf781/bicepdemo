...
resource appSvcAppConfigKeyValues 'Microsoft.AppConfiguration/configurationStores/keyValues@2023-03-01' = [
  for key in appSvcAppConfigKeys: {
...
module appServiceModule '../modules/appServiceModule/v1.0.0/main.bicep' = {
  ...
  params: {
    ...
    webAppSettings: appSvcAppConfigKeys
    appInsights: monitoringModule.outputs
